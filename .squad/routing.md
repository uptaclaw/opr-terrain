...
|-----------|----------|----------|
| React components, UI, canvas, styling | Builder | Build features, fix UI bugs, implement drag-and-drop, canvas rendering |
| Architecture, refactoring, system design | Architect | Component structure, state management patterns, code organization |
| Code review | Architect | Review PRs, check quality, suggest improvements |
| Testing | Checker | Write unit/e2e tests, find edge cases, verify fixes, CI verification |
