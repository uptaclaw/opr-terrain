import type { TerrainPoint, TerrainPreset, TerrainTrait } from '../terrain/types';

/**
 * Predefined irregular polygon shapes for terrain.
 * Coordinates are normalized around origin for scaling.
 */
const FOREST_IRREGULAR: TerrainPoint[] = [
  { x: -1.05, y: -0.45 },
  { x: -0.45, y: -1.05 },
  { x: 0.4, y: -0.9 },
  { x: 1.05, y: -0.3 },
...
const HILL_IRREGULAR: TerrainPoint[] = [
  { x: -1.1, y: -0.2 },
  { x: -0.6, y: -1 },
  { x: 0.3, y: -1.05 },
  { x: 1.15, y: -0.35 },
...
const BUILDING_L_SHAPE: TerrainPoint[] = [
  { x: 0, y: 0 },
  { x: 3, y: 0 },
  { x: 3, y: 2 },
  { x: 1.5, y: 2 },
...
const WATER_STRIP: TerrainPoint[] = [
  { x: -1.4, y: -0.45 },
  { x: -0.6, y: -0.75 },
  { x: 0.2, y: -0.55 },
  { x: 1.3, y: -0.2 },
...
const ROCKY_OUTCROP_IRREGULAR: TerrainPoint[] = [
  { x: -1.05, y: -0.55 },
  { x: -0.15, y: -1.15 },
  { x: 0.95, y: -0.7 },
  { x: 1.1, y: 0.1 },
...
const HEDGE_CURVED: TerrainPoint[] = [
  { x: -1.35, y: -0.25 },
  { x: -0.55, y: -0.8 },
  { x: 0.35, y: -0.65 },
  { x: 1.35, y: -0.15 },
