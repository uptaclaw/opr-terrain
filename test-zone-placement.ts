...
// Test the zone-based placement with deterministic seeds
const seeds = [1, 2, 3, 4, 5, 42];

console.log('Testing zone-based OPR placement...\n');
...
for (const seed of seeds) {
  ...
  console.log(`  Edge-to-edge clear: ${v.edgeToEdgeClear ? '✗' : '✓'}`);
  console.log(`  ALL VALID: ${v.allValid ? '✓✓✓' : '✗✗✗'}`);
  console.log('');
}
